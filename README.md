...
モバイルでのドラッグ軌道を記録する調査・実験アプリ。修論研究「モバイル入力ダイナミクスから調査回答の確信度を推定する」の Stage 1〜2 のパイロット実装で、現状は **Stage 1 (装置妥当性確認)** = 数値サイズ一致性課題 (Ouellette Zuk, 2025) のリーチデシジョン版。Stage 2 (価値・選好 / 道徳ジレンマブロック) は順次追加予定。

**公開URL**: <https://and-space83.github.io/drag-survey/>
